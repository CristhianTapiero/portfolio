...
export const Intro = () =>{
    ...
    return(
        <AnimatePresence>
            <motion.div 
            className="flex w-5/6 h-5/6 max-sm:w-9/12 flex-col justify-center items-center gap-y-6 py-4"
            variants={child}
            >
                ...
                >
                    <Image  priority src="/profile.png" alt="Profile pic" height={200} width={200} className="rounded-full shadow-lg shadow-brand-500 dark:shadow-brand-300"/>
                </motion.div>
